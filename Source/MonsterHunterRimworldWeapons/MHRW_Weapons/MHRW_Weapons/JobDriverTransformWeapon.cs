    ...
    public class JobDriverTransformWeapon : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            transformWeaponPreparations.initAction = delegate ()
            {
                ...
                {
                    totalNeededWork = compWeaponTransform.GetTransformTimeInSeconds().SecondsToTicks();
            ...
            transformWeaponPreparations.WithProgressBar(TargetIndex.A, () => 1f - workLeft / totalNeededWork, false, -0.5f);
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref totalNeededWork, "totalNeededWork", 0f, false);
        }
